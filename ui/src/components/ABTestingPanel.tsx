    ...
    <div className="flex flex-col h-full glass-panel p-4 md:p-8 overflow-y-auto custom-scrollbar">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-32 space-y-4">
          ...
          <div className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500">Syncing live content feed...</div>
        </div>
      ) : variations.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-32 space-y-4">
          <Rocket className="w-12 h-12 text-slate-600" />
          <div className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500">No generated variants found. Trigger the brain first.</div>
        </div>
      ) : (
        <>
              ...
              >
                ...
                <div className="relative h-32 overflow-hidden shrink-0">
                  {variation.image ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-white/5 text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500">
                ...
                <div className="p-5 space-y-4 flex-grow flex flex-col">
                  <div>
                    <div className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-400">{variation.label}</div>
          ...
          <div className="glass-panel p-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <button
                onClick={onNavigatePerformance}
                className="text-[11px] font-semibold uppercase tracking-[0.15em] text-indigo-400 flex items-center gap-2 px-4 py-2 bg-indigo-500/10 rounded-xl border border-indigo-500/20"
              >
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 p-6 bg-emerald-500/5 border border-emerald-500/10 rounded-xl flex flex-col gap-4">
              ...
              <div className="p-6 bg-white/5 border border-white/10 rounded-xl flex flex-col justify-between">
                <div className="space-y-1">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500">Confidence Score</div>
