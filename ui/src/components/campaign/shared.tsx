/**
 * Shared constants, helpers, and sub-form components
 * used across the campaign/ sub-components and CampaignPreview.tsx.
 */
...
export const AUDIENCE_OPTIONS = [
  'Founders', 'CEO', 'COO', 'CRO', 'VP Revenue', 'VP Revenue Operations',
  'Demand Gen Leaders', 'Heads of Growth', 'CMO', 'Marketing Operations',
];

export const OFFER_OPTIONS = [
  'Book a 20 minute audit', 'Book a strategy review', 'Request a demo',
  'Get a custom teardown', 'Start a pilot', 'Download the deck',
];

export const MARKET_OPTIONS = [
  'en-US', 'en-GB', 'de-DE', 'fr-FR', 'es-ES', 'DACH fintech',
  'UK SaaS', 'US SaaS', 'Mid-market SaaS', 'Enterprise SaaS', 'PLG SaaS', 'B2B services',
];

export const CHANNEL_OPTIONS = [
  'LinkedIn', 'Email', 'Landing page', 'Outbound calling',
  'Paid social', 'Google Search', 'Webinar', 'Partner co-marketing',
];

export const BRAND_VOICE_OPTIONS = [
  'Direct', 'Expert', 'Specific', 'No fluff', 'Analytical', 'Confident', 'Warm', 'Executive',
];
...
export function PresetMultiSelectField({
  label, value, options, placeholder, splitter, joiner, onChange,
}: {
  label: string;
  value: string;
  options: string[];
